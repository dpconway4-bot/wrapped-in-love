    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          height: '56px',
          borderRadius: '50%',
          background: 'rgba(250,178,77,0.1)',
        ...
        <button
          ...
          style={{
            ...
            padding: '13px',
            borderRadius: '12px',
            background: loading ? 'rgba(250,178,77,0.08)' : 'rgba(250,178,77,0.15)',
            border: '1px solid rgba(250,178,77,0.3)',
            color: loading ? 'rgba(250,178,77,0.4)' : 'var(--color-gold)',
            fontFamily: 'Jost, sans-serif',
            fontSize: '0.8rem',
            letterSpacing: '0.2em',
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '12px',
            background: 'none',
            border: '1px solid rgba(207,150,153,0.15)',
